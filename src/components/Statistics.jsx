      ...
      <div class="container  px-24 py-12 mx-auto">
        <div class="flex flex-col text-center w-full mb-20">
          ...
          <p class="lg:w-2/3 mx-auto leading-relaxed text-base">
            ...
            including food, clothing, educational materials, and medical
            ...
            a platform; we're driving a movement towards a more sustainable,
            equitable, and prosperous future for all Indians and beyond, one
            surplus resource at a time.
          </p>
        </div>
        <div class="flex flex-wrap -m-4 text-center">
          <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div class="border-2 border-gray-200 px-4 py-6 rounded-lg hover:bg-slate-200  hover:delay-80">
              <svg
                fill="none"
                stroke="currentColor"
              ...
              <p class="leading-relaxed">People Served</p>
            </div>
          </div>
          <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div class="border-2 border-gray-200 px-4 py-6 rounded-lg hover:bg-slate-200  hover:delay-80">
              ...
              <h2 class="title-font font-medium text-3xl text-gray-900">221</h2>
              <p class="leading-relaxed">NGOs Connected</p>
            </div>
          </div>
          <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div class="border-2 border-gray-200 px-4 py-6 rounded-lg hover:bg-slate-200  hover:delay-80">
              ...
              <h2 class="title-font font-medium text-3xl text-gray-900">34</h2>
...
export default Statistics;
>>>>>>> 88b21d30bf73b5128ddd4e111dae2e9baed07957
=======
import React from "react";
...
export default Statistics;
>>>>>>> dfe70fa14463ae0a327ac79ec3f225d1bbcaa5ed
