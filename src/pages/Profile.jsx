        ...
        <div className="profile-page my-[70px] md:mx-[100px] ">
            <div className="md:flex">
                <ul className="flex-column space-y space-y-4 text-lg font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0">
                    <li>
                        <a href="#" className={`nav-link inline-flex items-center px-11 py-3 rounded-lg ${activeTab === 'profile' ? 'text-white bg-orange-500' : 'text-gray-500 dark:text-gray-400 bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700'}`} onClick={() => handleTabClick('profile')}>
                            Profile
                        </a>
                    </li>
                    <li>
                        <a href="#" className={`nav-link inline-flex items-center text-center  px-3 py-3 rounded-lg ${activeTab === 'act-donation' ? 'text-white bg-orange-500' : 'text-gray-500 dark:text-gray-400 bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700'}`} onClick={() => handleTabClick('act-donation')}>
                            Active Donations
                        </a>
                    </li>
                    <li>
                        <a href="#" className={`nav-link inline-flex items-center px-3 py-3 text-center rounded-lg ${activeTab === 'his-donation' ? 'text-white bg-orange-500' : 'text-gray-500 dark:text-gray-400 bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700'}`} onClick={() => handleTabClick('his-donation')}>
                            Donation History
                        </a>
                    </li>
                    <li>
                        <a href="#" className={`nav-link inline-flex items-center px-12 py-3 rounded-lg ${activeTab === 'FAQs' ? 'text-white bg-orange-500' : 'text-gray-500 dark:text-gray-400 bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700'}`} onClick={() => handleTabClick('FAQs')}>
                            FAQs
                        </a>
                    </li>
                    {/* Add similar code for other navigation links */}
                </ul>
                <div id="profile-tab" className={`tab-content p-6 bg-gray-100 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full ${activeTab === 'profile' ? 'block' : 'hidden'}`}>
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Profile Tab</h3>
                    <p className="mb-2 text-3xl">Welcome User</p>
                    <p>This is the profile section where you can get your information on previous donations</p>
                    ...
                    <div className="value-tabs flex flex-wrap justify-between gap-3 mt-[30px]">
                        <div className="flex-auto max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <a href="#">
                                <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Donation Value</h5>
                            </a>
                            <p className="mb-3 text-3xl font-normal text-gray-500 dark:text-gray-400">$0</p>
                        </div>
                        ...
                        <div className="flex-auto max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <a href="#">
                                <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Meals Donated</h5>
                            </a>
                            <p className="mb-3 text-3xl font-normal text-gray-500 dark:text-gray-400">0</p>
                        </div>
                        ...
                        <div className="flex-auto max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <a href="#">
                                <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">No. of Charities</h5>
                            </a>
                            <p className="mb-3 font-normal text-3xl text-gray-500 dark:text-gray-400">0</p>
                        </div>
                    </div>

                </div>
                <div id="act-donation-tab" className={`tab-content p-6 bg-gray-100 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full ${activeTab === 'act-donation' ? 'block' : 'hidden'}`}>
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Active Donation Tab</h3>
                    <p className="mb-2">This is some placeholder content for the Dashboard tab's associated content.</p>
                    <div className="flex">
                        ...
                        <div class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-3xl mb-3 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                            <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg" src={dnimg1} alt="" />
                            <div class="flex flex-col justify-between p-4 leading-normal">

                                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Wedding Food</h5>

                                <div className="flex">


                                    <div className="block">
                                        <p class=" font-bold text-gray-700 dark:text-gray-400">Pickup Date & Time</p>
                                        <p>Monday, April 22, 10:18 AM</p>
                                    </div>
                                    <div class="vl"></div>
                                    <div className="block">
                                        <p class=" font-bold text-gray-700 dark:text-gray-400">Pickup Location</p>
                                        <p>Shivaji Lawn, Shahu Nagar,Besa rd.<br /> Nagpur - 440034</p>
                                    </div>
                                    <div className="vl m-0"></div>
                                    <div className="block">
                                        <p class=" font-bold text-gray-700 dark:text-gray-400">Specific Instructions</p>
                                        <p>Na</p>
                                    </div>
                                </div>
                        ...
                        <div className="block ms-2 mt-2">
                            <button type="button" class="text-white  bg-orange-500 hover:bg-orange-700 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Accept</button>
                            <button type="button" class="text-white   bg-gray-500 hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Decline</button>
                    ...
                    <div className="flex">
                        ...
                        <div class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-3xl mb-3 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                            <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg" src={dnimg2} alt="" />
                            <div class="flex flex-col justify-between p-4 leading-normal">
                                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Food Donation Box</h5>
                                ...
                                <div className="flex">
                                    ...
                                    <div className="block">
                                        <p class=" font-bold text-gray-700 dark:text-gray-400">Pickup Location</p>
                                        <p>Happy Foods, Bajaj Nagar,Besa rd.<br /> Nagpur - 440027</p>
                                    </div>
                                    <div className="vl m-0"></div>
                                    <div className="block">
                                        <p class=" font-bold text-gray-700 dark:text-gray-400">Specific Instructions</p>
                ...
                <div id="his-donation-tab" className={`tab-content p-6 bg-gray-100 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full ${activeTab === 'his-donation' ? 'block' : 'hidden'}`}>
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Donation History Tab</h3>
                    <p className="mb-2">This is some placeholder content for the Dashboard tab's associated content.</p>
                    <div class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-4xl mb-3 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                            <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg" src={dnimg3} alt="" />
                            <div class="flex flex-col justify-between p-4 leading-normal">
                                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Party Food Donation</h5>
                ...
                <div id="FAQs-tab" className={`tab-content p-6 bg-gray-100 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full ${activeTab === 'FAQs' ? 'block' : 'hidden'}`}>
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">FAQs Tab</h3>
                    <hr></hr>
